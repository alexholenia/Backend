...
<body>
    <form action="" method="POST">
        <label>Ім'я: <input type="text" name="name" id="name" required/></label>
        <label>Посада: <input type="text" name="position" id="position" required/></label>
        <label>Зарплата: <input type="number" name="salary" id="salary" required/></label>
